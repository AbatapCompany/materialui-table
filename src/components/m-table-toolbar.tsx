...
export class MTableToolbar extends Component<any, any> {
    ...
    defaultExportCsv = () => {
        const columns = this.props.columns
            .filter((columnDef: any) => !columnDef.hidden && columnDef.field && columnDef.export !== false)
        ...
        builder
            ...
            .setColumns(columns.map((columnDef: any) => {
                let title = '';
    ...
    renderDefaultActions() {
        ...
        const menuItems: any[] = [];
        this.props.columns.forEach((col: any, index: number, arr: any[]) => {
        ...
        return (
            <div>
                ...
                <this.props.components.Actions
                    actions={this.props.actions && this.props.actions.filter((a: any) => a.isFreeAction)}
    ...
    renderSelectedActions() {
        return (
            <React.Fragment>
                <this.props.components.Actions
                    actions={this.props.actions.filter((a: any) => !a.isFreeAction)}
