...
import { MTableBodyProps } from './models';

export default class MTableBody extends Component<MTableBodyProps> {

    static defaultProps: Partial<MTableBodyProps> = {
        actions: [],
        currentPage: 0,
        pageSize: 5,
        renderData: [],
    ...
    shouldComponentUpdate(nextProps: MTableBodyProps) {
    ...
    renderEmpty(emptyRowCount: any, renderData: any) {
        ...
        if (this.props.options.showEmptyDataSourceMessage && renderData.length === 0) {
            ...
            if (
                ...
                (this.props.actions && this.props.actions.filter((a) => !a.isFreeAction && !this.props.options.selection).length > 0)
            ) {
                addColumn++;
            }
