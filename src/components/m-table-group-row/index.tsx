...
import { MTableGroupRowProps } from './models';
import { Column } from '../../models/material-table.model';

export default class MTableGroupRow extends Component<MTableGroupRowProps> {
    ...
    render() {
        let colSpan = this.props.columns.filter((columnDef: Column) => !columnDef.hidden).length;
