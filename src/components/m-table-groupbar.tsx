...
export default class MTableGroupbar extends Component<any> {

    getItemStyle(_isDragging: any, draggableStyle: any) {
        return {
                ...
                <Droppable droppableId='groups' direction='horizontal'>
                    {(provided) => (
                        ...
                        >
                            ...
                            {this.props.groupColumns.map((columnDef: any, index: number) => {
                                return (
                                    <Draggable
