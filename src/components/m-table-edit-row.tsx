...
export default class MTableEditRow extends Component<any, any> {
                        ...
                        >
                            <EditComponent
                                ...
                                onChange={(value: any) => {
                                    ...
                                    if (value && cellProps.lookup && !isNaN(value)) {
                                        value = +value;
                                    }
    ...
    render() {
        ...
        if (this.props.mode === 'add' || this.props.mode === 'update') {
            ...
            const colSpan = this.props.columns.filter((columnDef: any) => {
        ...
        if (this.props.options.actionsColumnIndex === -1) {
            ...
            columns.splice(this.props.options.actionsColumnIndex as number + endPos, 0, this.renderActions());
        }
