...
export default class MTableFilterRow extends Component<any> {
    ...
    renderLookupFilter = (columnDef: any) => (
        <FormControl style={{ width: '100%' }}>
            <Select
                ...
                renderValue={selecteds => selecteds.map((selected: any) => columnDef.lookup[selected]).join(', ')}
                MenuProps={{
                    PaperProps: {
                        style: {
    ...
    render() {
        ...
        if (this.props.emptyCell && this.props.hasActions) {
            if (this.props.actionsColumnIndex === -1) {
                ...
                columns.splice(
                    this.props.actionsColumnIndex as number + endPos, 0,
                    <TableCell
                        key='key-action-column'
                        className={cellClassName(this.props.actionsColumnIndex as number + endPos)}
                    />
                );
            }
        }
