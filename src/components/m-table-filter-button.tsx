...
class MTableFilterButton extends Component<any, any> {
    ...
    handleOpenPopoverButtonClick(event: any) {
        this.setState({
    ...
    handleLookupCheckboxToggle(columnDef: any, key: any) {
    ...
    handleCheckboxToggle(columnDef: any) {
        let val = '';
    ...
    handleFilterNumericChange(columnDef: any, value: any, index: number) {
    ...
    renderFilterBody(columnDef: any) {
        if (columnDef.field || columnDef.customFilterAndSearch) {
            if (columnDef.lookup) {
    ...
    renderLookupFilter = (columnDef: any) => {
    ...
    renderBooleanFilter(columnDef: any) {
        const { classes } = this.props;
        return (
            <Checkbox
                className={classes.filterCheckbox}
    ...
    renderNumericFilter(columnDef: any) {
        const { classes } = this.props;
        return (
            <>
                <TextField
    ...
    renderDateTypeFilter = (columnDef: any) => {
        ...
        return (
            <span title={this.getFilterTitle()} className={classes.filterIconWrapper}>
                <this.props.icons.Filter
                    ...
                    aria-haspopup='true'
                    variant='contained'
                    onClick={(event: any) => this.handleOpenPopoverButtonClick(event)}
                />
                <Popover
                    id='filter-popover'
                    open={popoverOpened}
